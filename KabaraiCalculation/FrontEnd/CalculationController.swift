...
class CalculationController: UIViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if UIScreen.main.nativeBounds.height > 2208 || UIScreen.main.nativeBounds.height == 1792{
            scrollView.contentSize = CGSize(width:screenWidth, height: 980)
        }
        else{
        ...
        title1.textColor = UIColor.hex(string: "#00C2CB", alpha: 1.0)
        ...
        title2.textColor = UIColor.hex(string: "#00C2CB", alpha: 1.0)
        ...
        self.IncomeTextField1.placeholder = "25"
        ...
        title3.textColor = UIColor.hex(string: "#00C2CB", alpha: 1.0)
    ...
    @objc func onPressSubmit(_ sender : Any){
        ...
        if self.year == "0" &&
        ...
        else if Int(riritsu)! <= 15 && Int(kariire)! >= 100{
            let appearance = SCLAlertView.SCLAppearance(
                showCloseButton: true
            )
            let alert = SCLAlertView(appearance: appearance)
            alert.showSuccess("計算完了！", subTitle: "取り戻せる過払い金はありません", closeButtonTitle: "OK")
        }
        else if Int(riritsu)! <= 18 && Int(kariire)! < 100 && Int(kariire)! >= 10{
            let appearance = SCLAlertView.SCLAppearance(
                showCloseButton: true
            )
            let alert = SCLAlertView(appearance: appearance)
        ...
        else if Int(riritsu)! <= 20 && Int(kariire)! < 10{
            let appearance = SCLAlertView.SCLAppearance(
                showCloseButton: true
            )
            let alert = SCLAlertView(appearance: appearance)
            ...
            let alert = SCLAlertView(appearance: appearance)
            alert.showSuccess("計算完了！", subTitle: "取り戻せる過払い金は\n約\(Int(floor( result_num * 1 ) / 1))万円です！", closeButtonTitle: "OK")
        }
    }
    //借入額
    @objc func cancel0() {
